...
<a href="${p.link}" class="p-5 base-secondary-hoverable relative">
  <div class="flex items-center gap-4 mb-10">
    <img src="${p.img}" alt="${p.title}" style="width: ${p.w}rem; height: auto;">
    <span class="font-bold truncate leading-normal ${p.color}" style="font-size: 4vh;">
      ${p.title}
    </span>
  </div>

  <p class="absolute left-5 bottom-5 truncate line-clamp-2" style="font-size: 2vh;">
    ${p.desc}
  </p>
</a>
