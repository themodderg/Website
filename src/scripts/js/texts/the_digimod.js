document.getElementById("td-lore").innerHTML = `
    <p>
      ...
      <!-- TD-ABOUT-COUNTS:START (generated by src/scripts/sync_td_roster.py, do not hand-edit) -->It currently adds 155 digimon, with 367 more already modeled and being worked into the mod.<!-- TD-ABOUT-COUNTS:END -->
    </p>
  `;
